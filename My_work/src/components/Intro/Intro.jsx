    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          ...
          <span style={{ color: darkMode ? "blue" : "" }}>Make Fitness Your </span>
        ...
        <Link to="contact" smooth={true} spy={true}>
          <button className="button i-button">ContactUS</button>
        </Link>
        {/* social icons */}
      ...
      <div className="i-right">
        ...
        >
          <FloatinDiv img={crown} text1="Join" text2="Community" />
        </motion.div>
        ...
        >
          ...
          <FloatinDiv img={thumbup} text1="Ultimate" text2="Goal" />
        </motion.div>
